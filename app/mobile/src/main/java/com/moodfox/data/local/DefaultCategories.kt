...
object DefaultCategories {
    ...
    val all = listOf(
        ...
        CauseCategory(name = "Social",           emoji = "👥", sortOrder = 3,  isDefault = true),
        ...
        CauseCategory(name = "Stress",           emoji = "😰", sortOrder = 11, isDefault = true),
        ...
        CauseCategory(name = "No clear reason",  emoji = "🤷", sortOrder = 14, isDefault = true),
